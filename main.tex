...
\begin{document}
	...
	\begin{frame}
		\frametitle{Fisherface - Generalities and Training}
	...
	\begin{frame}
		...
		The dot product between the basis resulting from the PCA and the generalized eigenvector, we obtain a transformation which projects the flattened pictures directly on the latter, making this method particularly suitable for our problem.
